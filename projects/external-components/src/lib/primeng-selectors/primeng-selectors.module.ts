import { DailyExpencesComponent } from './components/Daily-expences-external/Daily-expences-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, DailyExpencesComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, DailyExpencesComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
