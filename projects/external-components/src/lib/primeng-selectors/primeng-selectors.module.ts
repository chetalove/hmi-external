import { SplitSpendingsComponent } from './components/Split-Spendings-external/Split-Spendings-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SplitSpendingsComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SplitSpendingsComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
